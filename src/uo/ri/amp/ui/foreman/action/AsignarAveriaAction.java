...
public class AsignarAveriaAction implements Action{
	...
	public void execute() throws Exception {
		...
		containsCorrectId(mecanicosExpertos, mecanico_id);
	...
	private void containsCorrectId(ArrayList<HashMap<String, Object>> mecanicosExpertos, long mecanico_id) throws BusinessException {
